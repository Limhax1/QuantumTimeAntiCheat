...
public abstract class Check implements MedusaCheck {
    ...
    public void setback(int ticks) {
        data.getPositionProcessor().setback(ticks);
    }
    ...
    public void debug(final Object... objects) {
        if (isDebugging()) {
            for (final Object object : objects) {
                data.getPlayer().sendMessage(ChatColor.RED + "[QTAC-Debug] " + ChatColor.GRAY + object);
            }
        }
    }
    ...
    public void debugToConsole(final Object... objects) {
        if (isDebugging()) {
            for (final Object object : objects) {
                System.out.println(ChatColor.RED + "[QTAC-Debug] " + ChatColor.GRAY + object);
            }
        }
    }
